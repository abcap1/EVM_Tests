...
contract LYNN is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        ILYNNBonusPool(bonusWallet).injectRewards(amountDogBonus);
    ...
    function clearStuckEthBalance() external onlyOwner {
        ...
        require(success, 'LYNN: ETH_TRANSFER_FAILED');
    }
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "LYNN: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _pairs.length() - 1, "LYNN: index out of bounds");
